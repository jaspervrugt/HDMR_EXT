...
plugin = struct('T_e',500:1:700,'beta',1/6,'a0',0,'solution',solver,'n',201,'options',odeset);
...
for i = 1:N
    ...
    Y(i,1:plugin.n) = a_s';
    % print progress
    fprintf(1, repmat('\b',1,prev)); prev = fprintf('MODEL EVALUATIONS: %3.2f%% DONE',100*(i/N)); 
end
